...
class VueConnexion{
    ...
    private function afficherCompteClient(){
        $client = $this->array;
        $var = "<section>
	<div class=\"container\">
		<div class=\"row\">
			<div class=\"col-4\">
				<div class=\"row\">";
        $var .="<h3>Compte n° ".$client->id_client."</h3>";
        $var .= "<div id=\"stars\"></div>
				</div>
			</div>
			<div class=\"col-8\">
				<form>
					<div class=\"form-group\">
						<label>Nom</label>
						<input type=\"text\" class=\"form-control\" value='".$client->nom_client."' readonly>
					</div>
					<div class=\"form-group\">
						<label>Prénom</label>
						<input type=\"text\" class=\"form-control\" value='".$client->prenom_client."' readonly>
					</div>
					<div class=\"form-group\">
						<label>Email</label>
					...
					<div class=\"form-group\">
						...
						<input type=\"text\" class=\"form-control\" value='".$client->nom_util."' readonly>
					</div>
					<div class=\"form-group\">
						<label>Numéro de téléphone</label>
						<input type=\"text\" class=\"form-control\" value='".$client->num_tel."' readonly>
					</div>
				</form>
			</div>
		</div>
    ...
    private function afficherCompteVendeur(){
        $vendeur = $this->array;
        $var = "<section>
	<div class=\"container\">
		<div class=\"row\">
			<div class=\"col-4\">
				<div class=\"row\">";
        $var .="<h3>Compte n° ".$vendeur->id_vendeur."</h3>";
        $var .= "<div id=\"stars\"></div>
				</div>
			</div>
			<div class=\"col-8\">
				<form>
					<div class=\"form-group\">
						<label>Nom</label>
						<input type=\"text\" class=\"form-control\" value='".$vendeur->nom_vendeur."' readonly>
					</div>
					<div class=\"form-group\">
						<label>Prénom</label>
						<input type=\"text\" class=\"form-control\" value='".$vendeur->prenom_vendeur."' readonly>
					</div>
					<div class=\"form-group\">
						<label>Email</label>
						<input type=\"email\" class=\"form-control\" value='".$vendeur->email."' readonly>
					</div>
					<div class=\"form-group\">
						<label>Adresse</label>
						<input type=\"text\" class=\"form-control\" value='".$vendeur->adresse."' readonly>
					</div>
					<div class=\"form-group\">
						<label>Nom utilisateur</label>
						<input type=\"text\" class=\"form-control\" value='".$vendeur->nom_util."' readonly>
					</div>
				</form>
			</div>
		</div>
    ...
    public function render($id=0){
        switch($id){
            ...
            case 3:
                ...
                break;
            case 4 :
                $content = $this->afficherCompteClient();
                break;
            case 5:
                $content = $this->afficherCompteVendeur();
                break;
            case 6:
